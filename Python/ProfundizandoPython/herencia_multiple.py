...
# Lista Enteros y Lista Ordenada
...
# Lista Enteros y Lista Ordenada
lista_enteros_ordenados = ListaEnterosOrdenada([4, 5, -1, 10, 14, -4])
print(lista_enteros_ordenados)
lista_enteros_ordenados.agregar(-20)
print(lista_enteros_ordenados)
...
print('¿Es una lista de enteros ordenada?', isinstance(lista_enteros_ordenados, ListaEnterosOrdenada))
print('¿Es lista de enteros?', isinstance(lista_enteros_ordenados, ListaEnteros))
print('¿Es una lista ordenada?', isinstance(lista_enteros_ordenados, ListaOrdenada))
print('¿Es una lista simple?', isinstance(lista_enteros_ordenados, ListaSimple))
print('¿Es un objeto?', isinstance(lista_enteros_ordenados, object))
